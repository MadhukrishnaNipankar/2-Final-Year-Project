    ...
    if (is_loggedin.loggedin === false) {
        ...
        return (
            <div className='LeftBar'>
                <div class="offcanvas offcanvas-start custom-width" data-bs-backdrop="false" tabindex="-1" id="offcanvasLeft" aria-labelledby="offcanvasLeftLabel">
                    ...
                    <div class="offcanvas-body">
                        ...
                        <div className='container d-flex loginAndSignupContainer'>
                            <div className='my-auto'>
                                <svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" fill="currentColor" class="bi bi-person-badge-fill" viewBox="0 0 16 16">
